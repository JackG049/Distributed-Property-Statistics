...
public class MockDataSource {
    private final int MAX_RETURNED_LISTINGS = 5;
     ...
     * @param startDate for the listings
     * @param endDate for the listings
    ...
    public Map<String, PropertyMessage> getPropertyListings(String dataSourceName, String startDate, String endDate) {
        ...
        try {
            samplePropertyData = generatePropertyData(MAX_RETURNED_LISTINGS);
        } catch (IOException e) {
    ...
    private static List<PropertyData> generatePropertyData(long numberProperties) throws IOException {
